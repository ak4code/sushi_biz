                    ...
                    <div class="uk-flex uk-flex-middle uk-flex-wrap uk-child-width-1-2@m uk-child-width-1-1">
                        ...
                        <div>
                            ...
                            <div class="uk-inline" v-else>
                                <a class="uk-form-icon" uk-icon="icon: minus" @click.prevent="decrement(product.id)"></a>
                                <input class="uk-input uk-form-small uk-text-center" readonly style="padding-right: 40px" type="text" :value="itemCart(product.id).quantity">
                                <a class="uk-form-icon uk-form-icon-flip" uk-icon="icon: plus" @click.prevent="increment(product.id)"></a>
                            </div>
                        </div>
                    </div>
                </div>
